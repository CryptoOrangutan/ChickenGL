 ...
 { case mode of
  ...
  //iceman
           ...
           // ÷ыпл€тки  ___________________________
            ...
            glColor3f(1,1,0);
            glPushMatrix;
             glTranslatef(0,0,0.2);              //хвостик
           glutSolidSphere(0.15,20,20);
           glPopMatrix;

           glTranslatef(0,0,1.3);            //мид
           glutSolidSphere(1,30,30);
           glPopMatrix;
  ...
  {___________________________________________________}
           ...
           glLineWidth(5);
           glBegin(GL_LINES);
           glVertex3f(-0.8,-0.9,-1.2);  //front foot
           glVertex3f(-1.4,-2.1,-1.2);

           glVertex3f(-0.65,-0.9,-1.7);   //back foot
           glVertex3f(-1.4,-1.9,-1.9);

           glVertex3f(-1.4,-2.1,-1.2);  //front fingers
           glVertex3f(-1.4,-2,-0.9);

           glVertex3f(-1.4,-1.9,-1.9);  //back fingers
           glVertex3f(-2,-0.6,-2.1);
           ...
           glColor3f(0,0,0);      //правый глаз
           glPushMatrix;
           glTranslatef(0.2,-1.3,-0.1);
           glutSolidSphere (0.05, 20, 20);
           glPopMatrix;

           { glPointSize(20);    //зрачок
           glColor3f(0,0,0);
           glBegin(GL_POINTS);
           glVertex3f(0.2,-1.3,-0.1);
           glEnd;  }
...
begin
  ...
  glEnable (GL_DEPTH_TEST);  //    позвол€ет работать в 3д
